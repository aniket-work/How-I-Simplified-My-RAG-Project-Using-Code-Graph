...
1. **Virtual Environment Setup:**
   - Create a dedicated virtual environment for our project:
     ...
     ```bash
     python -m venv How-I-Simplified-My-RAG-Project-Using-Code-Graph
     ```
   - Activate the environment:
   
     - Windows:
       ```bash
       How-I-Simplified-My-RAG-Project-Using-Code-Graph\Scripts\activate       
       ```
     - Unix/macOS:
       ```bash
       source How-I-Simplified-My-RAG-Project-Using-Code-Graph/bin/activate
       ```
