            ...
            <header className="border p-4">
                <form className="flex flex-row gap-2" onSubmit={handleSubmit}>
                    ...
                    </Select>
                    {
                        !LIMITED_MODE &&
                        <>
                            <Input placeholder="Submit Your Github Repository URL" className="border" type="url" onChange={handleRepoInputChange} />
                            <Button type="submit" className="border-none"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></Button>
                        </>
                    }
                </form>
            </header>
